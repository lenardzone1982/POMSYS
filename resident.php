<title>POMSYS | Accused People Management</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
            <h3>Accused People Management</h3>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
              <li class="breadcrumb-item active">Accused People Management</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div class="card-header p-2">
                <div class="row">
                  <div class="col-md-7 d-flex align-items-center">
                    <a href="resident_add.php" class="btn btn-sm bg-primary ml-2"><i class="fa-sharp fa-solid fa-square-plus"></i> Add New Accused</a>
                  </div>

                  <div class="col-md-3">
                    <select class="form-control select2" id="accused_person">
                      <option value="">All Residents</option>
                      <?php 
                        $sql = mysqli_query($conn, "SELECT residenceId, firstname, middlename, lastname, suffix FROM residence ORDER BY lastname ASC");
                        while ($row = mysqli_fetch_assoc($sql)) {
                            ...
                            echo '<option value="' . $row['residenceId'] . '">' . htmlspecialchars(ucwords($fullName)) . '</option>';
                        }
                      ?>
                    </select>
                  </div>
                  ...
                  <div class="col-md-2">
                    ...
                    <a href="export.php?export=resident" class="btn btn-sm bg-success"><i class="fa-solid fa-file-excel"></i> Export</a>
                  </div>
                </div>
              </div>
                    ...
                    ?>
                       <tr>
                            ...
                            <td>
                              ...
                              <a class="btn btn-info btn-sm" href="resident_update.php?residenceId=<?php echo $row['residenceId']; ?>"><i class="fas fa-pencil-alt"></i> Update </a>
                    ...
                    ?>
                      ...
                      <tr>
                          ...
                          <td>
                            ...
                            <a class="btn btn-info btn-sm" href="resident_update.php?residenceId=<?php echo $row['residenceId']; ?>"><i class="fas fa-pencil-alt"></i> Update </a>
                              <?php if($row['personalDocuments'] != ''): ?>
                                <a class="btn btn-warning btn-sm" href="resident_document.php?residenceId=<?php echo $row['residenceId']; ?>"><i class="fa-solid fa-file"></i> Document </a>
                              <?php else: ?>
                                <a class="btn btn-warning btn-sm" href="resident_document.php?residenceId=<?php echo $row['residenceId']; ?>"><i class="fa-solid fa-file"></i></a>
                              <?php endif; ?>
                              <button type="button" class="btn bg-danger btn-sm" data-toggle="modal" data-target="#delete<?php echo $row['residenceId']; ?>"><i class="fas fa-trash"></i> delete </button>
...
<script>
  $(document).ready(function() {
    ...
    $('#accused_person').select2({
      placeholder: "Select Accused Person",
      allowClear: true
    });

    $('#accused_person').on('change', function() {
      ...
      if (selectedCaseNo) {
        exportBtn
          ...
          .attr('href', 'exportBlotter.php?exportResident=' + encodeURIComponent(selectedCaseNo))
          .attr('onclick', '');
      } else {
        exportBtn
          .addClass('disabled')
