<title>POMSYS | Brgy Indigency Certificate</title>
<?php 
                ...
                <!-- END CERTIFICATE SIDEBAR -->
                  ...
                  <div class="col-8">
                    <!-- BACKGROUND LOGO -->
                      ...
                      <p class="text-sm m-0" style="text-indent: 30px; text-align: justify;">This is to certify that <b><?php echo ' '.$row['firstname'].' '.$row['middlename'].' '.$row['lastname'].' '.$row['suffix'].' '; ?></b> is a bonafide resident of Barangay Calapacuan and is presently residing at <?php echo ' '.$row['house_no'].' '.$row['street_name'].' '.$row['purok'].' '.$row['zone'].' '.$row['barangay'].' '.$row['municipality'].' '.$row['province'].' '.$row['region'].' '; ?>; that he/she belongs to the indigent cluster of our barangay.</p>
                      <br>
