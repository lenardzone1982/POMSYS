<title>POMSYS | Barangay ID</title>
<?php 
            ...
            <div class="invoice mb-3" id="printElement" style="border: none;line-height: 16px;">
                  ...
                  <div class="row p-0 m-0 position-relative" style="max-height: 480px; min-height: 480px;">
                    ...
                    <div class="col-3  text-center" >
                      ...
                      <span class="bg-light p-1">2025-<?php echo $IDNumber; ?></span></h5>
                    </div>
                    <div class="col-6  text-center text-white" style="text-shadow: 2px 0 #fff;">
                       <address>
                        Republic of the Philippines<br>
                        <strong>Subic Zambales</strong><br><br>
                        <span class="h4 " style="letter-spacing: 5px; color: #ffcce6 !important; text-shadow: 3px 0 #ffcce6;"><b>Barangay Calapacuan</b></span><br>
                      </address>
                    </div>    
                    <div class="col-3">
                  ...
                  <div class="row p-0 m-0" style="max-height: 500px; min-height: 500px;border: 4px solid black;">
                    ...
                    <div class="col-9 mt-3" style="line-height: 25px;">
                        ...
                        <div class="row">
                          ...
                          <div class="col-6 text-center mt-5">
                            <p>___________________________</p> 
                            <p style="margin-top: -25px;">HON. EARL ROD C. ARBOLEDA <p>
                    ...
                    <div class="col-12 text-center text-bold position-relative" style="line-height: 16px; text-align: justify; margin-top: 5px;">
                      <p style="font-style: italic;  font-size: 13px;">THIS IS TO CERTIFY THAT THE BEARER OF THIS CARD WHOSE PICTURE, SIGNATURE AND THUMB MARK APPEAR HERE ON IS A REGISTERED RESIDENT OF BARANGAY CALAPACUAN,SUBIC,ZAMBALES. <br> THIS IDENTIFICATION CARD IS BEING ISSUED FOR WHATEVER <br>LAWFUL PURPOSE IT MAY SERVE. </p><br>

                      <p class="text-sm" style="letter-spacing: 2px; margin-top: -25px;line-height: 13px;">Barangay Calapacuan Multi-Purpose Hall, Subic,Zambales, Philippines <br>
                      Contact Number: 09776032531</p>
                    </div>
