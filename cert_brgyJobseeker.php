<title>POMSYS | Brgy Job Seeker Certificate</title>
<?php 
                    ...
                    <!-- BACKGROUND LOGO -->
                      ...
                      <div class="row" >
                        <div class="col-6 d-flex justify-content-center mt-5 pt-5">
                          <div class="">
                              <p>Witnessed by:</p>
                              <p>Sitti Marriam G. Fahada Ahari</p>
                        ...
                        <div class="col-6">
                            <div class="text-center mb-5">
                              <br>
                              <p style="border-top: 1px solid grey;"><strong>HON. EARL ROD C. ARBOLEDA</strong></p>
                            ...
                            <p class="text-sm float-right" style="margin-top: -10px;">Name</p>
                        </div>
                      </div>
                  </div>
                </div>
                 ...
                 <div class="col-sm-12 text-justify p-5" style="margin-bottom: -30px;">
                  ...
                  <div class="col-sm-4">
                    ...
                    <div class="text-center">
                      ...
                      <br>
                      <small>_________________________</small><br> 
                      <small><b>SITTI MARIAM FAHADA G.AHARI</b></small><br>
                      <small class="text-muted">Barangay Secretary</small><br>
                      <small><b>Barangay CALAPACUAN, ZSUBIC</b></small>
                    </div>
                  </div>
