<title>POMSYS | Accused info</title>
                ...
                <div class="card-body p-3">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-8 col-md-6 col-sm-6 col-12">
                        <div class="form-group">
                          <span class="text-dark"><b>History</b></span>
                          <input type="text" class="form-control"  placeholder="history" name="familyIndicator" required>
                        </div>
                    </div>
                    <div class="col-lg-8 col-md-8 col-sm-6 col-12">
                        <div class="form-group">
                          <span class="text-dark"><b>Picture</b></span>
                          <div class="input-group">
