            ...
            <div class="invoice mb-3" id="printElement" style="border: none;line-height: 16px;">
                  ...
                  <div class="row p-0 m-0" style="max-height: 500px; min-height: 500px;border: 4px solid black;">
                    ...
                    <div class="col-12 text-center text-bold" style="line-height: 16px; text-align: justify;">
                      <p style="font-style: italic;">THIS IS TO CERTIFY THAT THE BEARER OF THIS CARD WHOSE PICTURE, SIGNATURE AND THUMB MARK APPEAR HERE ON IS A REGISTERED RESIDENT OF BARANGAY CALAPACUAN, SUBIC. <br> THIS IDENTIFICATION CARD IS BEING ISSUED FOR WHATEVER <br>LAWFUL PURPOSE IT MAY SERVE. </p><br>

                      <p style="letter-spacing: 2px;">Barangay CALAPACUAN Multi-Purpose Hall , SUBIC, ZAMBALES., Philippines <br>
