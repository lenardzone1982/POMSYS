<title>POMSYS | Brgy Ownership certificate</title>
<?php 
                ...
                <!-- END CERTIFICATE SIDEBAR -->
                  ...
                  <div class="col-8">
                    <!-- BACKGROUND LOGO -->
                      ...
                      <p class="text-sm m-0" style="text-indent: 30px; text-align: justify;">This is to certify that <b><?php echo ' '.$row['firstname'].' '.$row['middlename'].' '.$row['lastname'].' '.$row['suffix'].' '; ?></b> is a bonafide resident of Barangay Calapacuan with present address located at <?php echo ' '.$row['house_no'].' '.$row['street_name'].' '.$row['purok'].' '.$row['zone'].' '.$row['barangay'].' '.$row['municipality'].' '.$row['province'].' '.$row['region'].' '; ?>.</p>
                      <br>
                      <p class="text-sm m-0" style="text-indent: 30px; text-align: justify;">This is to further certify that he/she is the owner of the house erected over the land owned by SUBIC AUTHORITY located in the above-mentioned address.</p>
                      <br>
