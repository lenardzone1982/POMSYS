                  ...
                  <div class="row p-0 m-0 position-relative" style="max-height: 500px; min-height: 500px;">
                    ...
                    <div class="col-6  text-center text-white" style="text-shadow: 2px 0 #fff;">
                       <address>
                        ...
                        <strong>Zambales, Subic</strong><br><br>
                  ...
                  <div class="row p-0 m-0" style="max-height: 500px; min-height: 500px;border: 4px solid black;">
                    ...
                    <div class="col-12 text-center text-bold" style="line-height: 16px; text-align: justify;">
                     <?php 
                      ...
                      <p class="mt-3" style="font-style: italic;">THIS IS TO CERTIFY THAT THE BEARER OF THIS CARD WHOSE PICTURE, SIGNATURE AND THUMB MARK APPEAR HERE ON IS A REGISTERED RESIDENT OF BARANGAY CALAPACUAN, SUBIC,ZAMBALES. <br> THIS IDENTIFICATION CARD IS BEING ISSUED FOR WHATEVER <br>LAWFUL PURPOSE IT MAY SERVE. </p><br>

                      <p style="letter-spacing: 2px; margin-top: -15px;">Barangay Calapacuan Multi-Purpose Hall Pildera II, Pasay City 1300, MM., Philippines <br>
